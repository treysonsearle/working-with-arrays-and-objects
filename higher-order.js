...
//Code Here
let totalPopulation  = populations.reduce((x,y) => x + y, 0)
...
//Code Here
let myStrongest  = monstersInYourPocket.filter(filter)
...
let bobsTotal = purchases.filter(ownerFilter).reduce((previousValue, currentValue) => previousValue + currentValue.price,0)


console.log(bobsTotal)

function ownerFilter(obj){
